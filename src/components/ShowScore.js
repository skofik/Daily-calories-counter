  ...
  return (
    <>
      <div className="boardScore">
        {breakfastTab.length >= 1 ? (<BreakfastTab tabBreakfast={breakfastTab} remove={props.remove} />) : null}
        {secondBreakfastTab.length >= 1 ? (<SecondBreakfasTab secondBreakfastTab={secondBreakfastTab} remove={props.remove} />) : null}
        {dinnerTab.length >= 1 ? (<DinnerTab tabDinner={dinnerTab} remove={props.remove} />) : null}
        {snackTab.length >= 1 ? (<SnackTab snackTab={snackTab} remove={props.remove} />) : null}
        {supperTab.length >= 1 ? (<SupperTab supperTab={supperTab} remove={props.remove} />) : null}
      </div>
